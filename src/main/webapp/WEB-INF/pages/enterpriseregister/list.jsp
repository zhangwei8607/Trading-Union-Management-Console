		...
		<article class="col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
				...
				<div>
					...
					<c:url var="action" value="/enterpriseregister/list" />
					<form:form class="smart-form ng-pristine ng-valid"  action="${action}" method="post"  commandName="enterpriseregisterquery"  modelAttribute="enterpriseregisterquery">
						...
						<div class="row">
							<section class="col col-6">
								<label class="label"><spring:message code="s_gm_groupmng_enterpriseregister_List_fullName"/></label>
								<label class="input"><form:input class="form-control" placeholder="全称" path="fullName" ></form:input></label>
							</section>
							<section class="col col-6">
								<label class="label"><spring:message code="s_gm_groupmng_enterpriseregister_List_registerNo"/></label>
								<label class="input"><form:input class="form-control" placeholder="注册证号" path="registerNo" ></form:input></label>
							</section>
				</div>
							<div class="row">
							<section class="col col-6">
								<label class="label"><spring:message code="s_gm_groupmng_enterpriseregister_List_taxNo"/></label>
								<label class="input"><form:input class="form-control" placeholder="税务登记号" path="taxNo" ></form:input></label>
							</section>
							<section class="col col-6">
								<label class="label"><spring:message code="s_gm_groupmng_enterpriseregister_List_openAccountNo"/></label>
								<label class="input"><form:input class="form-control" placeholder="开户许可证号" path="openAccountNo" ></form:input></label>
							</section>
				</div>
							<div class="row">
							<section class="col col-6">
								<label class="label"><spring:message code="s_gm_groupmng_enterpriseregister_List_createDateStart"/></label>
								<label class="input"><input class="datepicker" size="20" path="createDateStart"></input></label>
							</section>
							<section class="col col-6">
								<label class="label"><spring:message code="s_gm_groupmng_enterpriseregister_List_createDateEnd"/></label>
								<label class="input"><input class="datepicker" size="20" path="createDateEnd"></input></label>
							</section>
				</div>
							<div class="row">
							<section class="col col-6">
								<label class="label"><spring:message code="s_gm_groupmng_enterpriseregister_List_failureDateStart"/></label>
								<label class="input"><input class="datepicker" size="20" path="failureDateStart"></input></label>
							</section>
							<section class="col col-6">
								<label class="label"><spring:message code="s_gm_groupmng_enterpriseregister_List_failureDateEnd"/></label>
								<label class="input"><input class="datepicker" size="20" path="failureDateEnd"></input></label>
							</section>
				</div>
							<div class="row">
							<section class="col col-6">
								<label class="label"><spring:message code="s_gm_groupmng_enterpriseregister_List_businessEntity"/></label>
								<label class="input"><form:input class="form-control" placeholder="法人" path="businessEntity" ></form:input></label>
							</section>
							<section class="col col-6">
								<label class="label"><spring:message code="s_gm_groupmng_enterpriseregister_List_entityIDNo"/></label>
								<label class="input"><form:input class="form-control" placeholder="法人证件号码" path="entityIDNo" ></form:input></label>
							</section>
				</div>
							<div class="row">
							<section class="col col-6">
								<label class="label"><spring:message code="s_gm_groupmng_enterpriseregister_List_entityIDType"/></label>
								<label class="input">
					...
					<c:forEach items="${enterpriseregisters }" var="_enterpriseregister">
						<tr>
							...
							<td>${_enterpriseregister.entityIDNo}</td>
							<td>${_enterpriseregister.taxNo}</td>
							<td>${_enterpriseregister.createDate}</td>
							<td>${_enterpriseregister.fullName}</td>
							<td>${_enterpriseregister.businessEntity}</td>
							<td>${_enterpriseregister.entityIDType}</td>
						</tr>
					</c:forEach>
					</tbody>
					</table>
	    ...
	    $('#enterpriseregisterquery').submit(function() {   
	    	$.ajax( {
				type : 'POST',
						...
						url : '/gm/enterpriseregister/list',
